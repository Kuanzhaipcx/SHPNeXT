...
from mmseg.models.backbones.mscan import Mlp, StemConv, OverlapPatchEmbed
from .poolformer import PoolFormerBlock
from .Hiremlp import Mlp, HireMLP
class MSCAAttention(BaseModule):
    ...
    def __init__(self,
                 ...
                 paddings=[[0, 3], [0, 5], [0, 7], [0, 10]]):
        super().__init__()
        self.conv0 = PoolFormerBlock(dim=dim)
        for i, (kernel_size,
                padding) in enumerate(zip(kernel_sizes[0:], paddings[0:])):
    ...
    def forward(self, x):
        ...
        attn_3 = self.conv2_1(attn)
        attn_3 = self.conv2_2(attn_3)
...
class MSCABlock(BaseModule):
    ...
    def __init__(self,
        ...
        self.attn = MSCASpatialAttention(channels, dim, attention_kernel_sizes,
